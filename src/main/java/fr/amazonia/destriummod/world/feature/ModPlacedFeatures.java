...
public class ModPlacedFeatures {
    ...
    public static final Holder<PlacedFeature> REPAIR_ORE_PLACED = PlacementUtils.register("repair_ore_placed", ModConfiguredFeatures.REPAIR_ORE, ModOrePlacement.commonOrePlacement(1, HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(-0), VerticalAnchor.absolute(100))));
}