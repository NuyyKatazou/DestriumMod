...
public class ModToolsTiers {
    ...
    public static final Tier ARGONIDE = TierSortingRegistry.registerTier(
    ...
    public static final Tier DESTRIUM = TierSortingRegistry.registerTier(
    ...
    public static final Tier AMAZONITE = TierSortingRegistry.registerTier(
