...
public class ModCreativeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> BLOCK_TAB = CREATIVE_MODE_TABS.register("block_tab", () -> CreativeModeTab.builder().withSearchBar().withTabsAfter(ModCreativeTabs.ITEM_TAB.getKey()).icon(() -> new ItemStack(ModBlocks.AMAZONITE_BLOCK.get())).title(Component.translatable("creativetab.destriummod.block_tab").withStyle(style -> style.withColor(TextColor.fromRgb(0x0D6DFF))).withStyle(ChatFormatting.BOLD)).displayItems((pParameters, pOutput) -> {
    ...
    public static final RegistryObject<CreativeModeTab> ITEM_TAB = CREATIVE_MODE_TABS.register("item_tab", () -> CreativeModeTab.builder().withSearchBar().withTabsAfter(ModCreativeTabs.TOOL_TAB.getKey()).icon(() -> new ItemStack(ModItems.AMAZONITE_FRAGMENT.get())).title(Component.translatable("creativetab.destriummod.item_tab").withStyle(style -> style.withColor(TextColor.fromRgb(0x0D6DFF))).withStyle(ChatFormatting.BOLD)).displayItems((pParameters, pOutput) -> {
    ...
    public static final RegistryObject<CreativeModeTab> TOOL_TAB = CREATIVE_MODE_TABS.register("tool_tab", () -> CreativeModeTab.builder().withSearchBar().withTabsAfter(ModCreativeTabs.FOOD_TAB.getKey()).icon(() -> new ItemStack(ModItems.AMAZONITE_PICKAXE.get())).title(Component.translatable("creativetab.destriummod.tool_tab").withStyle(style -> style.withColor(TextColor.fromRgb(0x0D6DFF))).withStyle(ChatFormatting.BOLD)).displayItems((pParameters, pOutput) -> {
    ...
    public static final RegistryObject<CreativeModeTab> FOOD_TAB = CREATIVE_MODE_TABS.register("food_tab", () -> CreativeModeTab.builder().withSearchBar().icon(() -> new ItemStack(ModItems.AMAZONITE_APPLE.get())).title(Component.translatable("creativetab.destriummod.food_tab").withStyle(style -> style.withColor(TextColor.fromRgb(0x0D6DFF))).withStyle(ChatFormatting.BOLD)).displayItems((pParameters, pOutput) -> {
