...
public class ModBiomes {
    ...
    public static Biome voidifiedBiome(BootstrapContext<Biome> context) {
    ...
    public static Biome mineralBiome(BootstrapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
    ...
    public static Biome enrichmentBiome(BootstrapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
