...
public class ModBiomes {
    ...
    public static final ResourceKey<Biome> VOIDIFIED_BIOME = ResourceKey.create(Registries.BIOME, new ResourceLocation(DestriumMod.MODID, "voidified_biome"));
    public static final ResourceKey<Biome> ENRICHMENT_BIOME = ResourceKey.create(Registries.BIOME, new ResourceLocation(DestriumMod.MODID, "enrichment_biome"));
    public static final ResourceKey<Biome> MINERAL_BIOME = ResourceKey.create(Registries.BIOME, new ResourceLocation(DestriumMod.MODID, "mineral_biome"));
