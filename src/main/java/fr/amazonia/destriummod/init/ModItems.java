...
public class ModItems {
    ...
    public static final RegistryObject<Item> NECKLACE = ITEMS.register("necklace", () -> new NecklaceArmor(ModArmorMaterials.NECKLACE, ArmorItem.Type.CHESTPLATE, component(new Item.Properties().fireResistant().stacksTo(1).component(DataComponents.UNBREAKABLE, new Unbreakable(true)), "necklace", ChatFormatting.GRAY)));
    public static final RegistryObject<Item> LUCKY_NECKLACE = ITEMS.register("lucky_necklace", () -> new LuckyNecklaceArmor(ModArmorMaterials.NECKLACE, ArmorItem.Type.CHESTPLATE, component(new Item.Properties().stacksTo(1).fireResistant().component(DataComponents.UNBREAKABLE, new Unbreakable(true)), "lucky_necklace", ChatFormatting.DARK_GREEN)));
