...
public class ModItems {
    ...
    public static final RegistryObject<Item> AMAZONITE_HELMET = registerItem("amazonite_helmet", (properties) -> new AmazoniteArmorHelmet(ModArmorMaterials.AMAZONITE, ArmorType.HELMET, component(properties.fireResistant(), "amazonite_helmet", ChatFormatting.DARK_AQUA)));
    public static final RegistryObject<Item> AMAZONITE_CHESTPLATE = registerItem("amazonite_chestplate", (properties) -> new AmazoniteArmorChestPlate(ModArmorMaterials.AMAZONITE, ArmorType.CHESTPLATE, component(properties.fireResistant(), "amazonite_chestplate", ChatFormatting.DARK_AQUA)));
    public static final RegistryObject<Item> AMAZONITE_LEGGINGS = registerItem("amazonite_leggings", (properties) -> new AmazoniteArmorLeggings(ModArmorMaterials.AMAZONITE, ArmorType.LEGGINGS, component(properties.fireResistant(), "amazonite_leggings", ChatFormatting.DARK_AQUA)));
    public static final RegistryObject<Item> AMAZONITE_BOOTS = registerItem("amazonite_boots", (properties) -> new AmazoniteArmorBoots(ModArmorMaterials.AMAZONITE, ArmorType.BOOTS, component(properties.fireResistant(), "amazonite_boots", ChatFormatting.DARK_AQUA)));

    public static final RegistryObject<Item> DESTRIUM_HELMET = registerItem("destrium_helmet", (properties) -> new DestriumArmor(ModArmorMaterials.DESTRIUM, ArmorType.HELMET, component(properties.fireResistant(), "destrium_helmet", ChatFormatting.DARK_GREEN)));
    public static final RegistryObject<Item> DESTRIUM_CHESTPLATE = registerItem("destrium_chestplate", (properties) -> new DestriumArmor(ModArmorMaterials.DESTRIUM, ArmorType.CHESTPLATE, component(properties.fireResistant(), "destrium_chestplate", ChatFormatting.DARK_GREEN)));
    public static final RegistryObject<Item> DESTRIUM_LEGGINGS = registerItem("destrium_leggings", (properties) -> new DestriumArmor(ModArmorMaterials.DESTRIUM, ArmorType.LEGGINGS, component(properties.fireResistant(), "destrium_leggings", ChatFormatting.DARK_GREEN)));
    public static final RegistryObject<Item> DESTRIUM_BOOTS = registerItem("destrium_boots", (properties) -> new DestriumArmor(ModArmorMaterials.DESTRIUM, ArmorType.BOOTS, component(properties.fireResistant(), "destrium_boots", ChatFormatting.DARK_GREEN)));

    public static final RegistryObject<Item> ARGONIDE_HELMET = registerItem("argonide_helmet", (properties) -> new ArgonideArmor(ModArmorMaterials.ARGONIDE, ArmorType.HELMET, component(properties.fireResistant(), "argonide_helmet", ChatFormatting.GOLD)));
    public static final RegistryObject<Item> ARGONIDE_CHESTPLATE = registerItem("argonide_chestplate", (properties) -> new ArgonideArmor(ModArmorMaterials.ARGONIDE, ArmorType.CHESTPLATE, component(properties.fireResistant(), "argonide_chestplate", ChatFormatting.GOLD)));
    public static final RegistryObject<Item> ARGONIDE_LEGGINGS = registerItem("argonide_leggings", (properties) -> new ArgonideArmor(ModArmorMaterials.ARGONIDE, ArmorType.LEGGINGS, component(properties.fireResistant(), "argonide_leggings", ChatFormatting.GOLD)));
    public static final RegistryObject<Item> ARGONIDE_BOOTS = registerItem("argonide_boots", (properties) -> new ArgonideArmor(ModArmorMaterials.ARGONIDE, ArmorType.BOOTS, component(properties.fireResistant(), "argonide_boots", ChatFormatting.GOLD)));

    public static final RegistryObject<Item> SPEED_BOOTS = registerItem("speed_boots", (properties) -> new SpeedArmorBoots(ModArmorMaterials.DESTRIUM, ArmorType.BOOTS, component(properties.fireResistant(), "speed_boots", ChatFormatting.DARK_GREEN)));
    public static final RegistryObject<Item> FEATHER_BOOTS = registerItem("feather_boots", (properties) -> new ArmorItem(ModArmorMaterials.DESTRIUM, ArmorType.BOOTS, component(properties.fireResistant(), "feather_boots", ChatFormatting.DARK_GREEN)));
    public static final RegistryObject<Item> JUMP_BOOTS = registerItem("jump_boots", (properties) -> new JumpArmorBoots(ModArmorMaterials.DESTRIUM, ArmorType.BOOTS, component(properties.fireResistant(), "jump_boots", ChatFormatting.DARK_GREEN)));
