...
public class ModFluidTypes {
    ...
    public static final ResourceLocation LAVA_STILL_RL = new ResourceLocation("minecraft", "block/lava_still");
    public static final ResourceLocation LAVA_FLOWING_RL = new ResourceLocation("minecraft", "block/lava_flow");
