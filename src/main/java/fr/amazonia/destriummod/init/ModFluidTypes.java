...
public class ModFluidTypes {
    ...
    public static final RegistryObject<FluidType> POISON_WATER_FLUID_TYPE = FLUID_TYPES.register("poison_water_fluid_type", () -> new PoisonWaterFluidType(WATER_STILL_RL, WATER_FLOWING_RL, WATER_OVERLAY_RL, 0xA13D57D6, new Vector3f(7f / 255f, 64f / 255f, 179f / 255f), FluidType.Properties.create().lightLevel(0).density(1000).temperature(300).viscosity(1000).sound(SoundAction.get("drink"), SoundEvents.HONEY_DRINK.get()).canConvertToSource(false)));

    public static final RegistryObject<FluidType> RESISTANCE_LAVA_FLUID_TYPE = FLUID_TYPES.register("resistance_lava_fluid_type", () -> new ResistanceLavaFluidType(LAVA_STILL_RL, LAVA_FLOWING_RL, WATER_OVERLAY_RL, new Vector3f(198f / 255f, 69f / 255f, 4f / 255f), FluidType.Properties.create().lightLevel(2).density(500).temperature(300).viscosity(100).sound(SoundAction.get("drink"), SoundEvents.HONEY_DRINK.get()).canConvertToSource(false)));
