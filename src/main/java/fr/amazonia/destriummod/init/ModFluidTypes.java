...
public class ModFluidTypes {
    ...
    public static final RegistryObject<FluidType> POISON_WATER_FLUID_TYPE = registerPoisonWater("poison_water_fluid_type", FluidType.Properties.create().lightLevel(0).density(1000).temperature(300).viscosity(1000).sound(SoundAction.get("drink"), SoundEvents.AMBIENT_UNDERWATER_LOOP).canConvertToSource(false));

    public static final RegistryObject<FluidType> RESISTANCE_LAVA_FLUID_TYPE = registerResistanceLava("resistance_lava_fluid_type", FluidType.Properties.create().lightLevel(2).density(500).temperature(300).viscosity(100).sound(SoundAction.get("drink"), SoundEvents.AMBIENT_UNDERWATER_LOOP).canConvertToSource(false));


    private static RegistryObject<FluidType> registerPoisonWater(String name, FluidType.Properties properties) {
    ...
    private static RegistryObject<FluidType> registerResistanceLava(String name, FluidType.Properties properties) {
