...
public class ModFluids {
	...
	public static final RegistryObject<FlowingFluidBlock> POISON_WATER_BLOCK = ModBlocks.BLOCKS.register("poison_water_block", () -> new PoisonWaterFluidBlock(ModFluids.POISON_WATER_FLUID, AbstractBlock.Properties.of(Material.WATER).noCollission().strength(100f).noDrops().speedFactor(0.95F)));
	
	public static final RegistryObject<FlowingFluidBlock> RESISTANCE_LAVA_BLOCK = ModBlocks.BLOCKS.register("resistance_lava_block", () -> new ResistanceLavaFluidBlock(ModFluids.RESISTANCE_LAVA_FLUID, AbstractBlock.Properties.of(Material.LAVA).noCollission().strength(100f).noDrops().speedFactor(0.95F).lightLevel((p_235470_0_) -> 14)));
}