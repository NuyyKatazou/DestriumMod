...
public class ModBlocks {
	...
	//(Ore)
	public static final RegistryObject<Block> RANDOM_ORE = registerBlock("random_ore", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(5f, 100f).requiresCorrectToolForDrops()));
	...
	public static final RegistryObject<Block> REPAIR_ORE = registerBlock("repair_ore", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(4f, 50f).requiresCorrectToolForDrops()));
	...
	//(Other)
	public static final RegistryObject<Block> AMAZONITE_RELIQUE_BLOCK = registerBlock("amazonite_relique_block", () -> new Block(BlockBehaviour.Properties.of(Material.METAL).strength(25.0F, 100.0F).requiresCorrectToolForDrops()));
	...
	public static final RegistryObject<Block> PARADIS_PORTAL_BLOCK = registerBlock("paradis_portal_block", () -> new ParadisPortalBlocks(BlockBehaviour.Properties.of(Material.CLAY).strength(10.0F, 200.0F).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> OVERWORLD_PORTAL_BLOCK = registerBlock("overworld_portal_block", () -> new OverworldPortalBlocks(BlockBehaviour.Properties.of(Material.CLAY).strength(10.0F, 200.0F).requiresCorrectToolForDrops()));
	...
	//public static final RegistryObject<FlowerBlock> CLOVER_TWO = BLOCKS.register("clover_two", () -> new FlowerBlock(MobEffects.LUCK, 9, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS)));
