...
public class ModBlocks {
	...
	//(Ore)
	public static final RegistryObject<Block> RANDOM_ORE = createBlock("random_ore", () -> new Block(AbstractBlock.Properties.of(Material.STONE).harvestTool(ToolType.PICKAXE).harvestLevel(5).strength(5f, 100f).requiresCorrectToolForDrops()));
	...
	public static final RegistryObject<Block> REPAIR_ORE = createBlock("repair_ore", () -> new Block(AbstractBlock.Properties.of(Material.STONE).harvestTool(ToolType.PICKAXE).harvestLevel(3).strength(4f, 50f).requiresCorrectToolForDrops()));
	...
	public static final RegistryObject<Block> PARADIS_PORTAL_BLOCK = createBlock("paradis_portal_block", () -> new ParadisPortalBlocks(AbstractBlock.Properties.of(Material.CLAY).harvestTool(ToolType.PICKAXE).harvestLevel(3).strength(10.0F, 200.0F).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> OVERWORLD_PORTAL_BLOCK = createBlock("overworld_portal_block", () -> new OverworldPortalBlocks(AbstractBlock.Properties.of(Material.CLAY).harvestTool(ToolType.PICKAXE).harvestLevel(3).strength(10.0F, 200.0F).requiresCorrectToolForDrops()));
