...
public class ModBlocks {
    ...
    //Compressed
    public static final RegistryObject<Block> COBBLESTONE_COMPRESSED1 = createBlock("cobblestone_compressed1", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(1.5f, 25f).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> COBBLESTONE_COMPRESSED2 = createBlock("cobblestone_compressed2", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(2f, 50f).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> COBBLESTONE_COMPRESSED3 = createBlock("cobblestone_compressed3", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(4f, 75f).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> COBBLESTONE_COMPRESSED4 = createBlock("cobblestone_compressed4", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(8f, 100f).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> COBBLESTONE_COMPRESSED5 = createBlock("cobblestone_compressed5", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(14f, 150f).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> COBBLESTONE_COMPRESSED6 = createBlock("cobblestone_compressed6", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(20f, 200f).requiresCorrectToolForDrops()));
