...
public class ModBlocks {
	...
	public static final RegistryObject<Block> BROWN_CLOUD = createBlock("brown_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> CYAN_CLOUD = createBlock("cyan_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> DARK_BLUE_CLOUD = createBlock("dark_blue_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> DARK_GRAY_CLOUD = createBlock("dark_gray_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> DARK_GREEN_CLOUD = createBlock("dark_green_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> DARK_PURPLE_CLOUD = createBlock("dark_purple_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> DARK_RED_CLOUD = createBlock("dark_red_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> GRAY_CLOUD = createBlock("gray_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> GREEN_CLOUD = createBlock("green_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> LIGHT_BLUE_CLOUD = createBlock("light_blue_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> LIGHT_GRAY_CLOUD = createBlock("light_gray_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> LIGHT_RED_CLOUD = createBlock("light_red_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> LIME_CLOUD = createBlock("lime_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> MAGENTA_CLOUD = createBlock("magenta_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> ORANGE_CLOUD = createBlock("orange_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> PINK_CLOUD = createBlock("pink_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> PURPLE_CLOUD = createBlock("purple_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> RED_CLOUD = createBlock("red_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> ULTRA_DARK_BLUE_CLOUD = createBlock("ultra_dark_blue_cloud", () -> new Block(BlockBehaviour.Properties.of(Material.CLAY).strength(3f, 25f).requiresCorrectToolForDrops()));
	...
	public static final RegistryObject<Block> PARADIS_ARGONIDE_ORE = createBlock("paradis_argonide_ore", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(4f, 10f).requiresCorrectToolForDrops()));
	...
	public static final RegistryObject<Block> COBBLESTONE_COMPRESSED4 = createBlock("cobblestone_compressed4", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(12.0F, 10.0F).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> COBBLESTONE_COMPRESSED5 = createBlock("cobblestone_compressed5", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(20.0F, 14.0F).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> COBBLESTONE_COMPRESSED6 = createBlock("cobblestone_compressed6", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(30.0F, 18.0F).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> COBBLESTONE_COMPRESSED7 = createBlock("cobblestone_compressed7", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(50.0F, 25.0F).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> COBBLESTONE_COMPRESSED8 = createBlock("cobblestone_compressed8", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(250.0F, 500.0F).requiresCorrectToolForDrops()));
	
	public static final RegistryObject<Block> DIRT_COMPRESSED1 = createBlock("dirt_compressed1", () -> new Block(BlockBehaviour.Properties.of(Material.DIRT).strength(3.0F, 6.5F).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> DIRT_COMPRESSED2 = createBlock("dirt_compressed2", () -> new Block(BlockBehaviour.Properties.of(Material.DIRT).strength(5.0F, 7.0F).requiresCorrectToolForDrops()));
