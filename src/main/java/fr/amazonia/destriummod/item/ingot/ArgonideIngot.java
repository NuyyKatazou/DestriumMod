...
public class ArgonideIngot extends Item {
    ...
    public ArgonideIngot(FabricItemSettings fireproof) {
        super(fireproof);
    }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(new TranslatableText(this.getTranslationKey() + ".desc3").formatted(Formatting.GOLD).formatted(Formatting.BOLD));
    }
}
